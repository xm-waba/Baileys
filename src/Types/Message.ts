...
export type WAMediaUploadFunction = (readStream: Readable, opts: { fileSha256B64: string, mediaType: MediaType, timeoutMs?: number, newsletter?: boolean }) => Promise<{ mediaUrl: string, directPath: string }>
